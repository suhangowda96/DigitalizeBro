        ...
        <div className="container mx-auto w-full">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 md:mb-8 leading-tight">
              ...
              <span
                className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent block leading-normal pb-2 text-3xl sm:text-4xl md:text-5xl lg:text-6xl"
                style={{
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-slate-300 mb-8 md:mb-12 leading-relaxed max-w-3xl">
              We create modern web solutions that combine creativity, technology, and strategy to bring your digital vision to life.
            </p>
            
            {/* Buttons - Adjusted Text Sizes */}
            <div className="flex flex-row flex-wrap gap-4 justify-start items-center w-full">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                onClick={onOpenContact}
                className="px-6 py-3 sm:px-8 sm:py-4 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-semibold rounded-lg transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 text-base sm:text-lg"
              >
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-6 py-3 sm:px-8 sm:py-4 border border-slate-600 hover:border-blue-400 text-slate-300 hover:text-blue-400 font-semibold rounded-lg transition-all duration-300 backdrop-blur-sm bg-slate-800/30 text-base sm:text-lg"
              >
